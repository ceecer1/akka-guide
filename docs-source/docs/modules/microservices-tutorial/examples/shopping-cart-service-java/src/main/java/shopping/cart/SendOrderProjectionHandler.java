...
public final class SendOrderProjectionHandler extends R2dbcHandler<EventEnvelope<ShoppingCart.Event>> {
  ...
  @Override
  public CompletionStage<Done> process(R2dbcSession session, EventEnvelope<ShoppingCart.Event> envelope)
      throws Exception {
